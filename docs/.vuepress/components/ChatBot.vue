   ...
   <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
      ...
      <form @submit.prevent="sendMessage" class="relative flex">
         ...
         <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
            ...
            <button type="submit" v-if="inputMessage" class="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-gray-400 hover:bg-blue-400 focus:outline-none">
